...
import Controlador.ReduccionPorcentajeListener;
...
public class PanelReduccionPorcentaje extends PanelEditorImagen{
    ...
    private SpinnerNumberModel reduccion_porcentaje_spinner_model;
    private String mensaje_label;
    private ReduccionPorcentajeListener listener;
    private PanelAutoaceptar panel_autoaceptar;
    
    private final int VALOR_INICIAL = 100;
    ...
    public PanelReduccionPorcentaje(Interfaz ventana_principal){
        ...
        this.ventana_principal = ventana_principal;
        this.reduccion_porcentaje_spinner_model = new SpinnerNumberModel(VALOR_INICIAL,0,100,1);
        this.mensaje_label = "Reducción (% tamaño original) : ";
        this.listener = new ReduccionPorcentajeListener(this,ventana_principal,VALOR_INICIAL);
        
        this.panel_autoaceptar = new PanelAutoaceptar(ventana_principal, reduccion_porcentaje_spinner_model,
                                                mensaje_label, listener);
