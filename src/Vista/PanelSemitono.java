...
public class PanelSemitono extends PanelEditorImagen {
    ...
    public PanelSemitono(Interfaz ventana_principal){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar las imagenes de semitonos", 
                                                    "Error", JOptionPane.ERROR_MESSAGE);
            
            System.out.println("Problema al cargar la imagenes de semitonos - PanelSemitono.java");
        }
